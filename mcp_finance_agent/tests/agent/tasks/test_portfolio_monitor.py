...
from mcp_finance_agent.agent.tasks.portfolio_monitor import PortfolioMonitor
from mcp_finance_agent.services.supabase.notification_service import NotificationType, NotificationPriority
...
async def test_monitor_user_portfolio(monitor, portfolio_snapshot):
    ...
    with patch('mcp_finance_agent.agent.tasks.portfolio_monitor.TinkoffClient', return_value=client):
